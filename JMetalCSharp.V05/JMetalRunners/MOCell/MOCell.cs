...
namespace JMetalRunners
{
    ...
    public class MOCell
    {
        ...
        ///   - MOCell
        ///   - MOCell problemName
        ///   - MOCell problemName ParetoFrontFile
        /// </summary>
        ...
        public static void Main(string[] args)
        {
            ...
            //algorithm = new JMetalCSharp.Metaheuristics.MOCell.sMOCell1(problem);
            //algorithm = new JMetalCSharp.Metaheuristics.MOCell.sMOCell2(problem);
            //algorithm = new JMetalCSharp.Metaheuristics.MOCell.aMOCell1(problem);
            //algorithm = new JMetalCSharp.Metaheuristics.MOCell.aMOCell2(problem);
            //algorithm = new JMetalCSharp.Metaheuristics.MOCell.aMOCell3(problem);
            algorithm = new JMetalCSharp.Metaheuristics.MOCell.MOCell(problem);
            ...
            Console.WriteLine("Total execution time: mocell" + estimatedTime + "ms");
            Console.ReadLine();
