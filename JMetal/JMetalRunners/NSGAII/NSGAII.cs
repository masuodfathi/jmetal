...
namespace JMetalRunners.NSGAII
{
	...
	public class NSGAII
	{
		...
		public static void Main(string[] args)
		{
			...
			{ // Default problem
              //problem = new JMetalCSharp.Problems.Kursawe.Kursawe("Real", 10);
              //problem = new JMetalCSharp.Problems.Kursawe.Kursawe("BinaryReal", 3);
              //problem = new JMetalCSharp.Problems.Water.Water("Int");
              //problem = new ZDT3("ArrayReal", 30);
              //problem = new ConstrEx("Real");
              //problem = new DTLZ1("Real");
              //problem = new OKA2("Real") ;
                problem = new JMetalCSharp.Problems.Regression.Regression("Real", 3);
			}
