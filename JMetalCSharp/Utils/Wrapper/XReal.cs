...
namespace JMetalCSharp.Utils.Wrapper
{
	...
	public class XReal
	{
		...
		public double GetValue(int index)
		{
            ...
            if (type == typeof(IntSolutionType))
            {
                result = ((Int)solution.Variable[index]).Value;
            }
		...
		public void SetValue(int index, double value)
		{
            ...
            if (type == typeof(IntSolutionType))
            {
                ((Int)solution.Variable[index]).Value = (int)value;
            }
            else if (type == typeof(ArrayRealSolutionType))
			{
		...
		public double GetLowerBound(int index)
		{
            ...
            if (type == typeof(IntSolutionType))
            {
                result = ((Int)solution.Variable[index]).LowerBound;
            }
            else if (type == typeof(BinaryRealSolutionType))
			{
		...
		public double GetUpperBound(int index)
		{
            ...
            if (type == typeof(IntSolutionType))
            {
                result = ((Int)solution.Variable[index]).UpperBound;
            }
            else if (type == typeof(BinaryRealSolutionType))
			{
