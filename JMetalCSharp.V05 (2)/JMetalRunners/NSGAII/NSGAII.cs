	...
	public class NSGAII
	{
		...
		public static void Main(string[] args)
		{
			...
			{ // Default problem
				...
				//problem = new Kursawe("BinaryReal", 30);
				//problem = new Water("Real");
				//problem = new ZDT3("BinaryReal", 30);
                //problem = new ConstrEx("Real");
                //problem = new JMetalCSharp.Problems.DTLZ.DTLZ1("Real");
                //problem = new OKA2("Real") ;
                //problem = new JMetalCSharp.Problems.Fonseca.Fonseca("BinaryReal");
                problem = new JMetalCSharp.Problems.MyProb.MyProb("Real",5,5);
            }
